...
void TelaPrincipal::compilaCodigoFonte() {
    ...
    while (dialogConteudo.size() > 0) { // Enquanto tiver código fonte faça
        ...
        /******************* Implementar verificação de Fim de Arquivo e de Comentário de Linha e Multiplas Linhas **********************/
    ...
    QString tokensIdentificados = "Tokens Identificados na analize Lexica \n";
    QString tokensNaoIdentificados = "Tokens que geraram erro na analize lexica \n";
